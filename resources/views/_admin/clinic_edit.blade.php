            ...
            <div class="card">
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin_clinic_update', $clinic->unqId) }}" class="form form-horizontal form-bordered" novalidate="" data-parsley-validate="" autocomplete="off">
                        	{{ csrf_field() }}
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="clinic_reference_num" class="form-control" value="{{ $clinic->clinic_profile->clinicRefNum }}" placeholder="Clinic Reference Number" name="clinic_reference_num" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row last">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" id="email" class="form-control" value="{{ $clinic->email }}" placeholder="Email" name="email" disabled>
                                    </div>
                                </div>

                        ...
                        <form method="post" action="{{ route('admin_clinic_store') }}" enctype="multipart/form-data" class="form form-horizontal form-bordered" novalidate="" data-parsley-validate="">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="clinic_reference_id" class="form-control" placeholder="Clinic Reference ID" name="clinic_reference_id" required data-parsley-required-message="Please enter Clinic Reference ID">
                                    </div>
                                </div>
                                <div class="form-group row">

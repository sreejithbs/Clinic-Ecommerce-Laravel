            ...
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin_poduct_store') }}" enctype="multipart/form-data" class="form form-horizontal form-bordered" novalidate="" data-parsley-validate="">
                        	{{ csrf_field() }}
                            <div class="form-body">

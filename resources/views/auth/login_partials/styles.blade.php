...
<link rel="stylesheet" type="text/css" href="{{ asset('modern_admin_assets/vendors/css/forms/icheck/custom.css') }}">
<!-- END VENDOR CSS-->
...
<link rel="stylesheet" type="text/css" href="{{ asset('modern_admin_assets/css/pages/login-register.css') }}">
<!-- END Page Level CSS-->
